            ...
            VStack {
                ...
                ScrollView {
                    HStack {
                        ...
                        NavigationLink(destination: MoneyDetailView(selectedOption: $selectedOption, id: .constant(0))) {
                            HStack(spacing: 20) {
                        ...
                        NavigationLink(destination: MoneyDetailView(selectedOption: $selectedOption, id: .constant(1))) {
                            HStack(spacing: 20) {
                                VStack {
                                    HStack {
                                        VStack(spacing: 5) {
                    ...
                    HStack {
                        NavigationLink(destination: MoneyDetailView(selectedOption: $selectedOption, id: .constant(2))) {
                            HStack(spacing: 20) {
                        ...
                        NavigationLink(destination: MoneyDetailView(selectedOption: $selectedOption, id: .constant(3))) {
                            HStack(spacing: 20) {
                    ...
                    HStack {
                        NavigationLink(destination: MoneyDetailView(selectedOption: $selectedOption, id: .constant(4))) {
                            HStack(spacing: 20) {
                        ...
                        NavigationLink(destination: MoneyDetailView(selectedOption: $selectedOption, id: .constant(5))) {
                            HStack(spacing: 20) {
