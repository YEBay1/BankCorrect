                ...
                ScrollView {
                    HStack {
                        ...
                        .sheet(isPresented: $isSecondScreenActive) {
                            MoneyDetailView(selectedOption: $selectedOption, id: .constant(0))
                        }
                        .cornerRadius(25)
                        ...
                        .sheet(isPresented: $isSecondScreenActive) {
                            MoneyDetailView(selectedOption: $selectedOption, id: .constant(1))
                        }
                        .cornerRadius(25)
                    }
                    ...
                    HStack {
                        ...
                        .sheet(isPresented: $isSecondScreenActive) {
                            MoneyDetailView(selectedOption: $selectedOption, id: .constant(2))
                        }
                        .cornerRadius(25)
                        ...
                        .sheet(isPresented: $isSecondScreenActive) {
                            MoneyDetailView(selectedOption: $selectedOption, id: .constant(3))
                        }
                        .cornerRadius(25)
                    }
                    ...
                    HStack {
                        ...
                        .sheet(isPresented: $isSecondScreenActive) {
                            MoneyDetailView(selectedOption: $selectedOption, id: .constant(4))
                        }
                        .cornerRadius(25)
                        ...
                        .sheet(isPresented: $isSecondScreenActive) {
                            MoneyDetailView(selectedOption: $selectedOption, id: .constant(5))
                        }
                        .cornerRadius(25)
                    }
